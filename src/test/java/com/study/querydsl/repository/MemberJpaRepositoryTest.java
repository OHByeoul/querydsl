...
class MemberJpaRepositoryTest {
    ...
    public void firstTest(){
        ...
        assertThat(mem1).isEqualTo(member);
    }

    @Test
    public void queryDslTest(){
        Member mem = new Member("mem2", 20);
        memberRepository.save(mem);
        List<Member> mem2 = memberRepository.findByUsernameQuerydsl("mem2");

        assertThat(mem2).containsExactly(mem);
    }
    ...
    public void searchBuilder(){
        ...
        List<MemberTeamDto> memberTeamDtos = memberRepository.searchByBuilder(memberSearchCondition);
